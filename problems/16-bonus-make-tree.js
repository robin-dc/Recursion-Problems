...
const makeTree = (categories, parent) => {
  // your code here
  let objects = {}
  categories.filter(object => parent === object.parent)
  .forEach(obj => objects[obj.id] = makeTree(categories, obj.id))
...
// console.log(JSON.stringify(makeTree(categories2, null), null, 2));
