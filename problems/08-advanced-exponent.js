...
//   // return 2 * (advancedExponent(2, (1 - 1) / 2) ** 2)   => 2 * 1 = 2
//     // return 1

// console.log(advancedExponent(2, 2)); // 4
//   // return advancedExponent(2, 2 / 2) ** 2
//     // return advancedExponent(2, 1 / 2) ** 2   => 0.5 ** 2
//       // return 1

// console.log(advancedExponent(2, 3)); // 8
//   // return 2 * (advancedExponent(2, (3 - 1) / 2) ** 2)       => 2 * 4 = 8
//     // return 2 * (advancedExponent(2, (2 - 1) / 2) ** 2)     => 2 * 2 = 4
//       // return 2 * (advancedExponent(2, (1 - 1) / 2) ** 2)   => 2 * 1 = 2
//         // return 1
